...
const DETAIL_CATEGORIES = {
  "飲食": ["全て", "ラーメン", "寿司", "焼肉", "居酒屋", "カフェ", "バー", "イタリアン", "フレンチ", "中華料理", "ファストフード", "スイーツ・ケーキ", "パン屋", "定食・食堂", "和食・割烹", "韓国料理", "カレー", "弁当・惣菜"],
  ...
  "医療・クリニック": ["全て", "内科", "外科", "皮膚科", "整骨院・接骨院", "鍼灸院", "整体", "歯科", "眼科", "耳鼻科", "産婦人科", "小児科", "心療内科・メンタルクリニック", "動物病院", "薬局・ドラッグストア"],
  "その他": ["全て", "不動産", "士業（税理士・行政書士）", "教育・学習塾", "保育園・幼稚園", "習い事・カルチャー教室", "フィットネス・ジム", "自動車販売・整備", "建設・リフォーム", "クリーニング・家事代行", "IT・デザイン", "エンタメ・イベント", "ペット関連", "公共・自治体サービス"]
};
